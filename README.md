...
A DC20 RPG integration module for the BG3 Inspired HUD system. This module adapts the core HUD functionality for the DC20 RPG system, providing token-specific HUD elements for abilities, spells, and effects with a design inspired by Baldur's Gate 3.
...
3.  Search for **BG3 Inspired HUD - DC20 RPG**.
4.  Click **Install** and enable the module in your world settings.

**Features:**
* Provides DC20 RPG-specific integration for the BG3 HUD framework.
...
- **The Dungeon Coach** for the DC20 RPG system that makes this possible.

*This module is not affiliated with, endorsed by, or connected to Larian Studios, The Dungeon Coach, or Baldur's Gate 3.*

## Support

Found a bug? Have a feature request?
* Submit issues via [GitHub Issues](https://github.com/BragginRites/bg3-hud-dc20rpg/issues).
